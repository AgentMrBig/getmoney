...
api_key.apiKey = "bu76jmf48v6rajd4sij0"
...
// Below the api. I changed to finnhubClient. as api. was not defined.
// Tick Data
...
finnhubClient.etfsIndustryExposure('SPY', (error, data, response) => {
    console.error(data);
});
